...
var UserAvatarController = /** @class */ (function () {
    ...
    UserAvatarController.prototype.saveImg = function (request, response) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var user_id, updateUserPhoto, fileName, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        user_id = request.user.id;
                        updateUserPhoto = tsyringe_1.container.resolve(UpdateUserAvatarService_1.default);
                        fileName = (_a = request.file) === null || _a === void 0 ? void 0 : _a.filename;
                        return [4 /*yield*/, updateUserPhoto.execute({
                                user_id: user_id,
