...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, nameEstablishment, email, password, createUser, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, nameEstablishment = _a.nameEstablishment, email = _a.email, password = _a.password;
                        createUser = tsyringe_1.container.resolve(CreateUserService_1.default);
                        return [4 /*yield*/, createUser.execute({ nameEstablishment: nameEstablishment, email: email, password: password })];
                    case 1:
                        user = _b.sent();
