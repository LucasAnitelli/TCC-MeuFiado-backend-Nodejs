...
var DiskStorageDebtor_1 = __importDefault(require("../../../shared/container/debtors/StorageDebtor/implementations/DiskStorageDebtor"));
var storageDebtor = new DiskStorageDebtor_1.default();
var UpdateUserAvatarService = /** @class */ (function () {
    ...
    UpdateUserAvatarService.prototype.execute = function (_a) {
        var user_id = _a.user_id, avatarFile = _a.avatarFile;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, user, fileName, bodyData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, storageDebtor.deleteFile(user.avatar)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, storageDebtor.saveFile(avatarFile)];
                    case 4:
                        fileName = _b.sent();
